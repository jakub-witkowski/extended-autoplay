...
int main()
{
    ...
    //printf("Units on the map counter: %d\n", units_on_the_map_counter);
    load_orders("player1.txt", "player2.txt", "rozkazy.txt", "status.txt", active_units, &units_on_the_map_counter); // read data from rozkazy.txt and player1.txt, analyze and write to status.txt
